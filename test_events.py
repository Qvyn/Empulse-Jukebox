    ...
    def test_personal_streaks(self):
        events = self.values(
            [
                ...
                "LogMedalTv: Warning: Failed to emit MedalTv event Penta Kill: ServersUnavailable",
                "LogMedalTv: Warning: Failed to emit MedalTv event Hexa Kill: ServersUnavailable",
                "LogMedalTv: Warning: Failed to emit MedalTv event 5 Kill Streak: ServersUnavailable",
                "LogMedalTv: Warning: Failed to emit MedalTv event 10 Kill Streak: ServersUnavailable",
                "LogMedalTv: Warning: Failed to emit MedalTv event 15 Kill Streak: ServersUnavailable",
                "LogMedalTv: Warning: Failed to emit MedalTv event 20 Kill Streak: ServersUnavailable",
            ]
        )
        self.assertEqual(
            [value for kind, value in events if kind == "stinger"],
            [
                "double_kill", "triple_kill", "quad_kill", "penta_kill",
                "hexa_kill", "five_kill", "ten_kill", "fifteen_kill",
                "twenty_kill",
            ],
        )
